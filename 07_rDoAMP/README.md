...
rDoAMP is re-written and now available as R pacakge ( https://github.com/ong8181/rDoAMP ). R package is executable in macOS and Windows, while scripts in this folder executable only in macOS. Please use R package version. Also, the content in this folder may be deleted in near future.
